export default class ApeHeading extends HTMLElement {
  constructor() {
    super();
    ...
    template.innerHTML = /* template */ `
      <style>
        ...
        :host( [size="3"] ) { 
          ...
          line-height: calc( 22px * var( --scaling, 1 ) );          
        }                
        :host( [size="4"] ) { 
        ...
        :host( [size="5"] ) { 
          ...
          line-height: calc( 26px * var( --scaling, 1 ) );
        }                                
        :host( [size="6"] ) { 
          font-size: calc( 24px * var( --scaling, 1 ) ); 
          line-height: calc( 30px * var( --scaling, 1 ) );          
        }                                
        :host( [size="7"] ) { 
        ...
        :host( [size="8"] ) { 
          ...
          line-height: calc( 40px * var( --scaling, 1 ) );          
        }                                
        :host( [size="9"] ) { 
...
window.customElements.define( 'ape-heading', ApeHeading );
